...
function Movie_detail({poster, year, title, genres, rating, summary}){
    return (
            <div className="movie-detail">
                <img src={poster} className="movie-detail__poster" alt={title} title={title}/>
                ...
                <Link to={{
                    pathname: './',
                }} className="movie-detail__back">Back</Link>
            </div>
